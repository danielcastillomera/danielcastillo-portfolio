...
export const translations = {
  es: {
    ...
    about: {
      ...
      items: [
        ...
        'Community Manager: Meta, TikTok, Instagram Ads',
        'Diseño UI/UX con Figma y evaluación heurística (Nielsen)',
      ],
      dashboard: 'Dashboard Enterprise v3.1.0',
  ...
  en: {
    ...
    about: {
      ...
      title: 'About me',
      bio: 'Software engineer in training focused on developing robust enterprise systems. Passionate about building digital solutions that solve real problems with modern technologies, clean code, and professional industry standards.',
      ...
      items: [
        ...
        'SRI Ecuador electronic invoicing',
        'REST APIs with robust validation',
        'Responsive and accessible interfaces',
        'Security: RLS, CSP, HSTS',
        'Community Manager: Meta, TikTok, Instagram Ads',
        'UI/UX Design with Figma and heuristic evaluation (Nielsen)',
      ],
      dashboard: 'Dashboard Enterprise v3.1.0',
