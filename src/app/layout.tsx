...
export const metadata: Metadata = {
  ...
  description: 'Portafolio profesional v7.6.2. Junior Full Stack Engineer / Developer y Community Manager especializado en Next.js, TypeScript, Supabase, Meta Ads, TikTok Ads. Disponible para contratación inmediata. Ecuador.',
