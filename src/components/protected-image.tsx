...
interface Props { src: string; alt: string; width: number; height: number; className?: string; priority?: boolean; }
export default function ProtectedImage({ src, alt, width, height, className = '', priority = false }: Props) {
  return (
