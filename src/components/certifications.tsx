...
export default function Certifications() {
  ...
  const statusConfig = {
    ...
    completed: {
      ...
      dot: 'bg-gray-400',
      badge: 'border-gray-400/30 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300',
    },
  };
              ...
              >
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span
                      className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs font-semibold ${status.badge}`}
                    >
                  ...
                  {/* Hours badge */}
                  <span className="rounded-md bg-gray-100 dark:bg-navy-800 px-2 py-0.5 text-xs font-mono text-gray-600 dark:text-gray-300 shrink-0">
                    {cert.hours}h
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                  <svg className="w-3.5 h-3.5 shrink-0 text-accent-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-gray-900 dark:text-white">
                ...
                <span className="ml-2 inline-flex items-center gap-1 rounded-full border border-blue-500/30 bg-blue-500/10 px-2 py-0.5 text-xs font-semibold text-blue-600 dark:text-blue-400">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                HarvardX · CS50x: Introduction to Computer Science · 2026
              </p>
            </div>
          </div>
        </div>
