...
export default function ScrollButtons() {
  ...
  // Fix 7: tooltip bg se adapta al tema — gris oscuro en modo claro, navy en modo oscuro
  const tip = 'pointer-events-none absolute bottom-12 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-gray-700 dark:bg-navy-700 px-2.5 py-1 text-[10px] font-medium text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 select-none';
  ...
  return (
    <>
      <button type="button"
        ...
        title={t.hero.irAlFinal} aria-label={t.hero.irAlFinal}
        ...
        <svg className={ico} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} aria-hidden="true">
      ...
      <button type="button"
        ...
        title={t.hero.irAlInicio} aria-label={t.hero.irAlInicio}
