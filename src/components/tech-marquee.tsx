...
export default function TechMarquee() {
  ...
  return (
    <section
      className="relative overflow-hidden border-y border-gray-100 dark:border-navy-800/50 bg-gray-50/50 dark:bg-navy-900/30 py-5"
    ...
    >
      ...
      <div
        ...
        role="marquee"
        aria-label="Stack tecnológico en uso"
      >
        {items.map((tech, i) => (
          <span
            key={`${tech}-${i}`}
            className="mx-6 text-sm font-semibold tracking-wide text-gray-500 dark:text-gray-400 whitespace-nowrap uppercase select-none flex items-center gap-2"
