  ...
  return (
    <div ref={ref} className="relative" onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
      ...
      >
        ...
        {/* Chevron */}
        <svg className={`w-3 h-3 transition-transform duration-200 ${open ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} aria-hidden="true">
      ...
      <div
        ...
        className={`absolute top-full left-0 mt-1 w-36 rounded-xl bg-white dark:bg-navy-900 shadow-xl shadow-black/10 dark:shadow-black/40 ring-1 ring-gray-200 dark:ring-navy-700 overflow-hidden z-50 transition-all duration-200 origin-top ${
