...
> `danielcastillo-portfolio` v7.6.6 · WCAG 2.1 Level AA
...
### Selección de texto (v7.6.6)

Desde v7.6.6, **todo el texto es completamente seleccionable** en PC y móvil.
...
### Text Selection (v7.6.6)

From v7.6.6, **all text is fully selectable** on PC and mobile.
