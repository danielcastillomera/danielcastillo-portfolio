...
> `danielcastillo-portfolio` v7.6.2 · WCAG 2.1 Level AA
...
### Selección de texto (v7.6.2)

Desde v7.6.2, **todo el texto es completamente seleccionable** en PC y móvil.
...
### Text Selection (v7.6.2)

From v7.6.2, **all text is fully selectable** on PC and mobile.
