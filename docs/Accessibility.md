...
> `danielcastillo-portfolio` v7.6.7 · WCAG 2.1 Level AA
...
### Selección de texto (v7.6.7)

Desde v7.6.7, **todo el texto es completamente seleccionable** en PC y móvil.
...
### Text Selection (v7.6.7)

From v7.6.7, **all text is fully selectable** on PC and mobile.
